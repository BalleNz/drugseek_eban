...
class MessageText:
    ...
    class help:
        ...
        SUBSCRIPTION = (
            ...
            f"Для полноценного использования бота необходимы подписки.\n\n"
            f"<b>Без подписок:</b>\n"
            f"<blockquote>"
    ...
    QUERIES_QUESTIONS = (
        ...
        "</blockquote>\n\n"
        "<b>В Профиле можно настроить сложность ответа</b>"
    )
    QUERIES_PHARMA = (
        "💡 <b>Задайте любой вопрос боту, подразумевающий список препаратов.</b>\n\n"
        "<b>Примеры запросов:</b>\n"
        "<blockquote>"
        "— «Препараты для улучшения секса»\n"
        "— «Хочу стать умнее какие препараты помогут?»\n"
        "</blockquote>\n\n"
        "<b>Вы увидите отсортированный по эффективности список.</b>"
    )
    QUERIES_DRUG_SEARCH = (
        "🔍 <b>Введите название препарата или действующего вещества.</b>\n\n"
        "<b>Примеры запросов:</b>\n"
        "<blockquote>"
        "— «Ноопепт»\n"
        "— «IGF-1»\n"
        ...
        "— «Фенибут»\n"
        "</blockquote>\n\n"
        "<b>Бот покажет полную информацию о препарате.</b>"
    )
    ...
    # [ positive / neutral ]
    DRUG_MANUAL_SEARCHING: str = "<b>Поиск препарата..</b>"
    ...
    DRUG_IS_BANNED: str = (
        ...
        "Запрос отклонён.\n\n"
        "<b>p.s. в премиум подписке можно.</b>"
    )
    ...
    NOT_EXIST_DRUG: str = "<b>Такого препарата не существует.</b>"

    # [ TOKENS ]
    NO_TOKENS: str = "🚫 <b>У вас не осталось токенов для запросов.</b>\n\n/tokens"
    ...
    GET_FREE_TOKENS_MENU = (
        "🧚‍♀️ <b>Здесь ты можешь получить токены бесплатно!</b>"
    )
