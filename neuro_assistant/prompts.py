class Prompts:
    GET_DESCRIPTION_DOSAGES: str = "" \
                  ...
                  "\"dosages_fun_fact\": <забавный факт про дозировку с нотками черного юмора, например: `для отказа печени достаточно N мг вещества!` или `для нахождения безопасной дозировки исследователи погубили K крыс!`>," \
