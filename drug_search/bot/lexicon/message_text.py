...
class MessageText:
    ...
    QUERIES_QUESTIONS = (
        "💡 <b>Задайте любой вопрос боту, он ответит на него детализировано и развернуто.</b>\n\n"
        ...
        "<tg-spoiler><b>В Профиле можно настроить формат ответа (простым языком / сложный)</b></tg-spoiler>"
    )
    QUERIES_PHARMA = (
        "💡 <b>Задайте любой вопрос боту, подразумевающий список препаратов или продуктов питания.</b>\n\n"
        "<b>Примеры запросов:</b>\n"
        "<blockquote>"
