class Prompts:
    ...
    Формат ответа строго в JSON:
    {
        ...
        "drugs": [
            {
                "drug_name": "<строго название действующего вещества>",
    ...
    Всегда обращай внимание на эти ЛУЧШИЕ препараты (если уместно, используй и в других вопросах):
        Если вопрос про ум / ноотропы:
        1. Ноопепт (омберацетам) лучший в этом роде
    ...
    4. Напиши 3 препарата самые эффективные
    5. Не используй запрещенные препараты
    6. Постарайся найти препараты, даже пользователь шутит
