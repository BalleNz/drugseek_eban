...
Revision ID: 064b9e7bc3ea
Revises: 
Create Date: 2025-10-04 15:36:13.387595
...
def upgrade():
    ...
    sa.Column('subscription_end', sa.DateTime(), nullable=True, comment='окончание подписки'),
