class Prompts:
    ...
    Формат:
    {
        ...
        "synonyms": ["<все возможные уникальные варианты названий для этого препарата на русском языке включая <drug_name_ru> до 20 штук (строго не путать с другими препаратами)>"],
        ...
        "sources": [<ссылки на drugs.com, drugbank.com, uptodate.com, fda.gov, apteka.ru — выбери самые надежные>]
    }
        ...
        "pathways": [
            {
                ...
                "activation_type": "<тип активации строго: agonist/antagonist/inhibitor/partial agonist/etc>",
    ...
    3. Очень строго. Указывай activation_type только из списка: 
       agonist, antagonist, inverse agonist, partial agonist, inhibitor, activator, modulator, blocker. 
       Если такого нет, пиши 'other'
    ...
    10. Если препарат — анаболический стероид, напиши в эффектах его влияние на простату и волосы. 
