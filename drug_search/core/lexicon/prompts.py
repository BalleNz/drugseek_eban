class Prompts:
    ...
    Формат:
    {
        ...
        "synonyms": ["<5-8 уникальных названий препарата (включая ДВ, drug_name_ru, drug_name на английском и обязательно скопируй сам запрос пользователя, строго не путать с другими препаратами)>"],
