class Prompts:
    ...
    Формат:
    {
        ...
        "pharmacokinetics": {
            "absorption": "<биодоступность>",
            "metabolism": "<пути метаболизма>",
            "elimination": "<пути выведения>",
        ...
        "description": "<краткое описание препарата>",
        "classification": "<классификации препарата>",
        "latin_name": "<название на латинском>",
        "drug_name": "<название ДВ на английском>",
        "drug_name_ru": "<название ДВ на русском>",
        "synonyms": ["<варианты названий>"],
    ...
    8. Для analogs указывай ближайшие аналоги или null
    9. Пример аналога для анаболика: {"analog_name": "Примаболан", "percent": 85, "difference": "Менее чувствителен к волосам и простате"}
    """
