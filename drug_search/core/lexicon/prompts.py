class Prompts:
    ...
    Формат:
    {
        ...
        "synonyms": ["<5-8 уникальных названий препарата (включая ДВ, drug_name_ru, drug_name на английском и запрос пользователя, строго не путать с другими препаратами)>"],
    ...
    Правила:
    1. Если данные отсутствуют - указывай None. 
    ...
    6. Ссылки на источники строго из приведенного списка
    7. Все ответы должны быть на русском языке
