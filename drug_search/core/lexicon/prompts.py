class Prompts:
    ...
    ВОЗВРАЩАЙ СТРОГО В ЭТОМ ФОРМАТЕ JSON:
    {
    ...
    3. absorption: Если нет данных о путях с ≥1% биодоступностью, укажи "Данные о путях с достаточной биодоступностью отсутствуют"
