...
class MessageText:
    ...
    class help:
        ...
        SUBSCRIPTION = (
            ...
            f"      ❌️ нет доступа к изучению некоторых препаратов\n"
            f"      ❌️ нет доступа к просмотру исследований\n\n"
            f"<b>2) <u>Премиум:</u></b>\n"
        ...
        TOKENS_FREE = (
            ...
            f"<b>2)</b> Токены за подписку на каналы: /free_tokens\n\n"
            f"<b>3)</b> Купить подписку: /subscription"
        )
