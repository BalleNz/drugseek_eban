class Prompts:
    ...
    Формат:
    {
        ...
        "synonyms": ["<строго только название, без ничего лишнего, примерно 10 уникальных вариантов названия для этого препарата на русском языке включая <drug_name_ru> (строго не путать с другими препаратами)>"],
        ...
        "pathways": [
            {
                ...
                "binding_affinity": "<Kd/Km/Ki в нМ или %>",
