class Prompts:
    ...
    JSON-ФОРМАТ ОТВЕТА:
    {
        ...
        "metabolism": [
            {            
                ...
                "result": "<результат этого процесса>"
            },
            ...
        ],
        ...
        "metabolism": [
            {
                "phase": "1",
                "process": "окисление",
                "result": "5α-дигидротестостерон (активный метаболит) через 5α-редуктазу в печени и периферических тканях"
            },
            {
                "phase": "1",
                "process": "окисление",
                "result": "эстрон и эстрадиол через ароматазу CYP19A1 в жировой ткани, печени"
            },
            {
                "phase": "1",
                "process": "гидроксилирование",
                "result": "андростендион через 17β-гидроксистероиддегидрогеназу в печени"
            },
            {
                "phase": "2",
                "process": "глюкуронизация",
                "result": "тестостерон-глюкуронид (UGT2B17) в печени - водорастворимый метаболит"
            },
            {
                "phase": "2",
                "process": "сульфатирование",
                "result": "тестостерон-сульфат (SULT2A1) в печени"
            },
            {
                "phase": "-1",
                "process": "почечная фильтрация",
                "result": "выведение конъюгированных метаболитов с мочой"
            }
        ],
    ...
    1. absorption: ВКЛЮЧАЙ ВСЕ ПУТИ, даже редкие
