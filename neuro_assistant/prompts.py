class Prompts:
    GET_DESCRIPTION_DOSAGES: str = "" \
                  ...
                  "}, " \
                  "Правила: " \
                  "1. Если данные отсутствуют - строго указывай null " \
    ...
    GET_PATHWAY: str = "" \
        ...
        "\"pathways\": [" \
            ...
            "...]," \
        "\"mechanism_summary\": {" \
            "\"primary_action\": <главный механизм препарата>", \
            "\"secondary_actions\": [\"<второстепенные мишени через запятую>\"]", \
            "\"clinical_effects\": [\"<описание всех клинических эффектов через запятую>\"]" \
        "}", \
        "\"sources\": [\"drugbank.com\", \"pubchem.ncbi.nlm.nih.gov\", ...]" \
        "}" \
        ...
        "3. activation_type: строго из списка: agonist, antagonist, inverse agonist, partial agonist, inhibitor, activator, modulator, blocker" \
        ...
        "2. Приоритет: рецензируемые статьи > DrugBank > PubChem" \
