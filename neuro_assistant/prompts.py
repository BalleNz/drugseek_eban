class Prompts:
    ...
    Формат:
    {
        ...
        "synonyms": ["<если есть, все возможные уникальные варианты названий для этого препарата на русском языке включая <drug_name_ru> как можно больше до 20-50 штук (строго не путать с другими препаратами)>"],
        "dosages_fun_fact": "<используй стиль Арсена Маркаряна и гопника, 
            СТИЛЬ умного профессора мгу с нотками припизднутости..... 
    ...
    7. Для запрещенных препаратов используй стиль Арсена Маркаряна
        ...
        "pathways": [
            {
                ...
                "source": "<источник данных про этот путь>",
    ...
    3. Указывай activation_type только из списка: 
